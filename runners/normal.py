...
class Runner():
    def __init__(self, device, model, database, split, model_label = 'baseline'):
        ...
        self.trn_ds = split(database, database.trn_metadata, output_col = ['normal_ecg'])
        self.val_ds = split(database, database.val_metadata, output_col = ['normal_ecg'])
        self.tst_ds = split(database, database.tst_metadata, output_col = ['normal_ecg'])
